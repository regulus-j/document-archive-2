                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <select id="parent_office_id" name="parent_office_id"
                                    class="pl-10 block w-full rounded-md border-slate-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('parent_office_id') border-red-300 text-red-900 focus:outline-none focus:ring-red-500 focus:border-red-500 @enderror">
