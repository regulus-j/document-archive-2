            ...
            <div class="flex gap-6 items-start">
                ...
                <div class="bg-white rounded-xl border border-slate-200 overflow-hidden flex-shrink-0" style="width: 22vw; min-width: 220px;">
                    ...
                    <div class="p-5 space-y-4 overflow-y-auto" style="min-height: 200px; max-height: 70vh;">
                        ...
                        {{-- Final Recipient Badge --}}
                        @if($workflow->is_final_recipient)
                        <div class="p-4 bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-400 rounded-lg">
                            <div class="flex items-start gap-3">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-amber-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" />
                                </svg>
                                <div>
                                    <p class="text-sm font-bold text-amber-900">You are the Final Recipient</p>
                                    <p class="text-xs text-amber-700 mt-1">You have final approval/rejection authority for this document. Your decision is the final verdict.</p>
                                </div>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="p-4 bg-gradient-to-r from-indigo-50 to-blue-50 border-2 border-indigo-300 rounded-lg">
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    <p class="text-sm font-bold text-indigo-900">Sub-Workflow Document</p>
                                    <p class="text-xs text-indigo-700 mt-1">This is a consultation request. After you complete your action, the document will return to <strong>{{ optional($workflow->parent)->recipient ? $workflow->parent->recipient->first_name . ' ' . $workflow->parent->recipient->last_name : 'the original forwarder' }}</strong> for their final decision.</p>
                                </div>
                            </div>
                        </div>
                        @endif
