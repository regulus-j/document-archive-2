                ...
                <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-2 mt-1">
                                ...
                                <button type="button" id="openCategoryManagerBtn"
                                    ...
                                    class="flex-shrink-0 inline-flex items-center justify-center w-10 h-10 rounded-lg border-2 border-indigo-500 text-indigo-600 bg-indigo-50/50 hover:bg-indigo-100/50 hover:border-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-200">
                    ...
                    <div id="categoryManagerOverlay"
                        ...
                        <div id="categoryManagerCard"
                             class="relative w-full max-w-lg mx-4 bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden transform transition-all duration-300 scale-95 opacity-0 flex flex-col"
                                        ...
                                        <div class="p-4 bg-slate-50 rounded-lg border border-slate-200" id="barcode-settings-section">
                                            <div class="flex items-start justify-between gap-3">
                                                ...
                                                <button type="button" onclick="openBarcodePreviewModal('createBarcodeModal')"
                                                        class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-indigo-700 bg-indigo-100/50 rounded-lg hover:bg-indigo-200 transition-colors whitespace-nowrap">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.border-dashed').forEach(function(zone) {
                ...
                ['dragenter', 'dragover'].forEach(function(evt) {
                    zone.addEventListener(evt, function() { zone.classList.add('border-indigo-400', 'bg-indigo-50/50'); }, false);
                });
                ['dragleave', 'drop'].forEach(function(evt) {
                    zone.addEventListener(evt, function() { zone.classList.remove('border-indigo-400', 'bg-indigo-50/50'); }, false);
                });
                ...
                tr.innerHTML = `
                    ...
                    <td class="px-4 py-3">
                        ${cat.is_global
                            ...
                            : '<span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-indigo-100/50 text-indigo-700">Company</span>'}
                    </td>
