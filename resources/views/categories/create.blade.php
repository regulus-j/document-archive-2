        ...
        <div class="bg-white rounded-lg p-6 border border-gray-200 mb-8 mt-8">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        <h1 class="text-xl font-semibold text-gray-900">{{ __('Create New Category') }}</h1>
                        <p class="text-sm text-gray-500">Add a new purpose/category label for documents</p>
                    </div>
                </div>
            ...
            <form action="{{ route('categories.store') }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @enderror
                        <p class="mt-1 text-xs text-gray-500">{{ __('This will be used as a document purpose/category label.') }}</p>
                    </div>
