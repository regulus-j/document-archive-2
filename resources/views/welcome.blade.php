...
<body class="font-sans bg-white text-slate-900">
    <!-- Navigation -->
    <nav class="bg-white border-b border-indigo-100">
        <div class="container mx-auto px-6 py-2 flex justify-between items-center">
            <a href="#" class="flex items-center space-x-3">
                <img src="{{ asset('images/logo.png') }}" alt="Document Tracking & Archiving" class="h-12 w-auto">
                <span class="text-xl font-semibold text-indigo-900">DocTrack</span>
            </a>
            
            <div class="flex items-center space-x-4">
                <a href="{{ route('login') }}" class="text-indigo-700 hover:text-indigo-800 transition-colors font-medium">Login</a>
                <a href="{{ route('register') }}"
                    class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md shadow-sm hover:shadow transition-all duration-200 font-medium">Sign Up</a>
            </div>
        </div>
    </nav>
        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row items-center">
                <div class="w-full md:w-1/2 mb-10 md:mb-0 pr-0 md:pr-12">
                    <h1 class="text-4xl md:text-5xl font-bold mb-6 text-indigo-900 leading-tight">Document Tracking & Archiving Made Easy</h1>
                    <p class="text-lg text-indigo-700 mb-8 max-w-lg">
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="inline-block bg-indigo-600 text-white px-6 py-3 rounded-md hover:bg-indigo-700 transition-colors shadow-md hover:shadow-lg font-medium">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-12 text-indigo-900">The DocTrack Difference</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2 text-indigo-800">Easy Upload</h3>
                    <p class="text-indigo-700">Upload documents from your device or scan physical documents directly into the system.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2 text-indigo-800">Track Documents</h3>
                    <p class="text-indigo-700">Monitor document locations, updates, approvals, and access history in real-time.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2 text-indigo-800">Quick Search</h3>
                    <p class="text-indigo-700">Find documents instantly using keywords, tags, or by scanning physical documents.</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold mb-2 text-indigo-800">Secure Storage</h3>
                    <p class="text-indigo-700">Protect sensitive information with role-based access controls and secure archiving.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Trusted By -->
    <section class="py-10 bg-slate-100 border-y border-slate-200">
        <div class="container mx-auto px-6">
    ...
    <section class="py-16 bg-white">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-4 text-indigo-900">Elevate Your Document Management</h2>
            <p class="text-center text-indigo-700 max-w-2xl mx-auto mb-16">Our comprehensive document management solution helps organizations streamline workflows, enhance security, and improve collaboration.</p>
            
            <!-- Document Management Solutions Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <!-- Solution 1: Document Tracking -->
                <div class="flex flex-col h-full">
                    <div class="bg-indigo-800 p-8 text-white">
                        ...
                        <a href="#" class="inline-block border border-white text-white px-4 py-2 rounded-md hover:bg-indigo-700 transition-colors">Learn More</a>
                    </div>
                    <div class="flex-grow">
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="bg-indigo-700 p-8 text-white">
                        ...
                        <a href="#" class="inline-block border border-white text-white px-4 py-2 rounded-md hover:bg-indigo-600 transition-colors">Learn More</a>
                    </div>
                </div>
                ...
                <div class="flex flex-col h-full">
                    ...
                    <div class="bg-indigo-600 p-8 text-white">
                        ...
                        <a href="#" class="inline-block border border-white text-white px-4 py-2 rounded-md hover:bg-indigo-500 transition-colors">Learn More</a>
                    </div>
                </div>
                ...
                <div class="flex flex-col h-full">
                    <div class="bg-indigo-500 p-8 text-white">
                        ...
                        <a href="#" class="inline-block border border-white text-white px-4 py-2 rounded-md hover:bg-indigo-400 transition-colors">Learn More</a>
                    </div>
                    <div class="flex-grow">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
                        ...
                        <div class="p-8">
                            ...
                            <a href="{{ route('register') }}" class="mt-8 block w-full bg-indigo-600 text-white text-center py-3 rounded-md hover:bg-indigo-700 transition-colors font-medium">
                                Start Now
                            </a>
                        </div>
                    </div>
    ...
    <section class="py-16 bg-indigo-800 text-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <p class="text-indigo-100 mb-8 max-w-2xl mx-auto">Join thousands of organizations that trust DocTrack for their document tracking and archiving needs.</p>
            <a href="{{ route('register') }}" class="inline-block bg-white text-indigo-800 px-8 py-3 rounded-md font-medium hover:bg-indigo-50 transition-colors shadow-lg">
                Get Started For Free
            </a>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div>
                    <div class="flex items-center space-x-3 mb-6">
                        <div class="h-10 w-10 bg-white rounded-md flex items-center justify-center">
                            <span class="text-indigo-900 font-bold text-xl">D</span>
                        </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Solutions</a></li>
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Enterprise</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Terms & Service</a></li>
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Privacy</a></li>
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Contact Us</a></li>
                    </ul>
                </div>
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Instagram</a></li>
                        <li><a href="#" class="text-indigo-200 hover:text-white transition-colors">Facebook</a></li>
                    </ul>
                </div>
            </div>
            <div class="pt-8 mt-8 border-t border-indigo-800 text-center text-indigo-300">
