            ...
            <div class="bg-white overflow-hidden shadow-xl rounded-xl border border-indigo-100">
                <div class="p-6">
                    <div class="text-center mb-8">
                        ...
                        <h2 class="mt-4 text-2xl font-bold text-slate-900">{{ $message }}</h2>
                        <p class="mt-2 text-slate-600">Your transaction has been processed successfully.</p>
                    </div>
                    ...
                    <div class="bg-indigo-50 rounded-lg p-6 mb-6 border border-indigo-100">
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Transaction Reference</dt>
                                <dd class="mt-1 text-sm text-slate-900">{{ $payment->transaction_reference }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Amount Paid</dt>
                                <dd class="mt-1 text-sm text-slate-900">₱{{ number_format($payment->amount, 2) }}</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Payment Method</dt>
                                <dd class="mt-1 text-sm text-slate-900">{{ ucfirst($payment->payment_method) }}</dd>
                            </div>
                            <div>
                    ...
                    <div class="bg-indigo-50 rounded-lg p-6 border border-indigo-100">
                        ...
                        <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            <div>
                                <dt class="text-sm font-medium text-slate-500">Plan Name</dt>
                                <dd class="mt-1 text-sm text-slate-900">{{ $plan->plan_name }}</dd>
                            </div>
                            <div>
