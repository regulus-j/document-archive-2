...
Route::middleware('guest')->group(function () {
    ...
    Route::get('login/select-company', [CompanySelectionController::class, 'show'])
        ->name('login.select-company');

    Route::post('login/select-company', [CompanySelectionController::class, 'authenticate'])
        ->name('login.authenticate-company');
